...
async def start_servers():
    ...
    try:
        ...
        print("✓ Optimized for free ngrok account")
        print("✓ Separate ports for HTTP and WebSocket")
        ...
        print("\nCurrent Setup:")
        print("✓ HTTP tunnel: https://1e6d229a057a.ngrok-free.app")
        print("✗ WebSocket tunnel: Not available (free account limit)")
        print("\nSolutions:")
