...
def recording_webhook():
    ...
    twiml = f"""<?xml version="1.0" encoding="UTF-8"?>
    <Response>
        <Say voice="alice" language="hi-IN">आपकी आवाज़ रिकॉर्ड हो गई है।</Say>
        <Say voice="alice" language="en-US">Your voice has been recorded.</Say>
        <Say voice="alice" language="hi-IN">कृपया प्रतीक्षा करें, मैं अनुवाद कर रहा हूं।</Say>
        <Say voice="alice" language="en-US">Please wait, I am processing your message.</Say>
        <Pause length="3"/>
        <Say voice="alice" language="hi-IN">अनुवाद प्रक्रिया पूरी हो गई है।</Say>
...
if __name__ == "__main__":
    try:
        ...
        print("="*70)
        print("Features:")
        print("✓ Optimized text-to-speech response")
